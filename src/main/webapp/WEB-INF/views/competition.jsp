...
<section class="container" ng-app="cartApp">
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <p><strong><springc:message code="competition.rules"/></strong> ${competition.rules}</p>
            <p><strong><springc:message code="competition.preferedTime"/> </strong>${competition.preferedTime}
                <springc:message code="competition.min"/></p>


            <p data-ng-controller="cartCtrl">
                <a href="#" ng-click="addToCart('${competition.competitionId}')"> <springc:message
                        code="competition.voteNow"/></a>
                <a href="<spring:url value="/competitions"/>"> <springc:message
